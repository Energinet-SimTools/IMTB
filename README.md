# Immittance Measurement ToolBox (IMTB)
...
The IMTB is licensed under the Mozilla Public License 2.0 (MPL-2.0). See the LICENSE file for details [License](https://github.com/Energinet-SimTools/IMTB?tab=License-1-ov-file). Any use of the IMTB is done under the following considerations: 
